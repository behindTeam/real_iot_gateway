...
/**
 * {@code InputOutputNode}는 {@code ActiveNode}를 상속하며, 입력 및 출력 노드의 기본 동작을 정의하는 추상
 * 클래스입니다.
 * 이 클래스는 입력 및 출력 와이어를 연결하고, 메시지를 해당 와이어로 전송하는 기능을 제공합니다.
 * 
 * <p>
 * {@code InputOutputNode}는 추상 클래스로, 구체적인 입력 및 출력 노드 타입은 이 클래스를 상속하여 구현해야 합니다.
 * </p>
 * 
 * <p>
 * 입력 및 출력 와이어 개수는 생성자를 통해 설정하며, 와이어를 연결하고 조회하는 메서드를 제공합니다.
 * </p>
 * 
 * <p>
